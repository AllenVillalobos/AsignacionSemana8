...
( USU_USUARIO, USU_CLAVE, USU_ESTADO, USU_ADICIONADO_POR, USU_FECHA_ADICION)
VALUES
('Allen','123','A','ADMIN',GETDATE());
...
VALUES
('301230456', 'María', 'Fernanda', 'Rodríguez', 'Soto', '88885555', 'maria.rod@gmail.com', 'ADMIN', GETDATE());
...
VALUES
('Luna', '2020-06-15', 'H', 12.50, 'Ninguna', 1, 'ADMIN', GETDATE());
...
VALUES
(GETDATE(), 'Fiebre leve y tos', 'Infección respiratoria', 'Antibióticos y reposo', 1, 'ADMIN', GETDATE());
